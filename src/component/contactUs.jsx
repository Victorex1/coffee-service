...
const Contact = () => {
    ...
    return ( 
        ...
        {load && <h3>Loading...</h3>}
         ...
         {data && 
           <div className=''>
            <img src={data[15].image} className='w-full h-60 relative sm:h-70 md:h-90 lg:h-110' alt=''/>
            <div className='absolute top-30 sm:top-40 lg:top-60 text-center mx-8/10 w-full'>
             <h2 className='text-5xl text-white font-bold sm:w-8/10 mx-auto sm-text-7xl'>Let's talk</h2>
            <p className='text-white leading-5 px-5 sm:text-2xl my-3'>We will love to know your want, For we serve the best for our customers</p>
            </div>
